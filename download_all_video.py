...
info_list = [[folder.strip(), animal_name.strip(), action.strip(), id_list[i]] for i in range(len(id_list))]
print(info_list)
video_index = [i for i in range(0, len(id_list))]
